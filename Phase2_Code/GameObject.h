...
public:
	...
	virtual void Save(ofstream &OutFile, GameObjectType Type) = 0;	// Saves the GameObject parameters to the file
	virtual bool Load(ifstream &Infile) = 0;	// Loads and Reads the GameObject parameters from the file
